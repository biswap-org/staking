...
contract('MasterChef', ([alice, bob, carol, dev, refFeeAddr, minter]) => {
    beforeEach(async () => {
        ...
        this.chef = await MasterChef.new(this.cake.address, dev, refFeeAddr, perBlock, '206', '1000', '875000', '100000', '43000', { from: minter });
    ...
    it('real case', async () => {
        ...
        //  await this.chef.add('750', this.lp3.address, true, { from: minter });
         //await this.chef.add('1000', this.lp4.address, true, { from: minter });
        ...
        console.log('----Deposit----');
        await this.chef.deposit(0, '1', { from: alice });
        await this.chef.deposit(0, '1', { from: bob });
        await this.chef.deposit(0, '1', { from: carol });
        console.log('---------------');
